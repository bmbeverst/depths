...
//		bodyFactory.makeCirclePolyBody(-4, 1, 2, BodyFactory.Materials.STONE, BodyType.DynamicBody, false);
		...
		// add some water
		Body water = bodyFactory.makeBoxPolyBody(1, -8, 40, 16, BodyFactory.Materials.RUBBER, BodyType.StaticBody,
				false);
	...
	/**
	 * Checks if point is in first fixture Does not check all fixtures.....yet
	 * 
