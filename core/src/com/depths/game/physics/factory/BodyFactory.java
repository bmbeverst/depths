...
public class BodyFactory {
	...
	public Body makeBoxPolyBody(float posx, float posy, float width, float height, Materials material,
			BodyType bodyType) {
	...
	public Body makePolygonShapeBody(Vector2[] vertices, float posx, float posy, Materials material,
			BodyType bodyType) {
		BodyDef boxBodyDef = new BodyDef();
		boxBodyDef.type = bodyType;
		boxBodyDef.position.x = posx;
